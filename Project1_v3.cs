...
namespace Project1_V3
{
    internal class Project1_v3
    {
        const int MAX_QUESTIONS = 10;   //Max questions per Project Guidelines
        
        static List<char> acceptedYN = new List<char>() { 'Y', 'N' };               //Valid options for Yes or No
        static List<char> acceptedAnswer = new List<char>() { 'A', 'B', 'C', 'D' }; //Valid options for answer choices
        ...
        public static bool ContinueQuiz()
        {
            ...
            nextQuestion = CSCI1250.CharValid.Validate("\nWould you like to go to the next question (Y) or stop and show final score (N)? ", "\nYou made an invalid choice please choose 'Y' or 'N'", acceptedYN);
        ...
        public static bool RepeatProgram()
        {
            ...
            repeatChoice = CSCI1250.CharValid.Validate("Would you like to do this again? Y/N: ", "\nYou made an invalid choice please choose 'Y' or 'N'\n", acceptedYN);
        ...
        public static int QuizUser(List<int> userQuestions, List<char> quizAnswers, int questionNum)
        {
            ...
            ansChoice = CSCI1250.CharValid.Validate("Enter your answer choice (A, B, C, D): ", "\nYou made an invalid choice. Please select A, B, C, or D", acceptedAnswer);
